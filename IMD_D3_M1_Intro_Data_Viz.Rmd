...
# NOTE: %<>% is a maggritr function that is reassigns a piped outcome to the original data frame. `joined_dat %<>%` is equivalent to `joined_dat <- joined dat %>%`
...
# View(joined_dat) to make sure the park units have been removed
```

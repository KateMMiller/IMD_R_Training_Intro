...
<h3>Step 2. Import and view the data</h3>
...
<h3>Step 3. Extract a subset of data</h3>
...
<h3>Step 4. Merge the `gas_constant` data with the `park_sub` data frame</h3>
...
<h3>Step 5. Check and clean/tidy the data</h3>
...
<h3>Convert `region` to a factor data type</h3>
...
<h3>Remove park units with missing years of data</h3>

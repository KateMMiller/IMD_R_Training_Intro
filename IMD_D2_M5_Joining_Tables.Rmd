...
Sometimes you don't want to combine two table, but you do want to filter one table so that it only has data that can match data in another table. semi_join() is used for this
...
Hint: the function is.na(data) will be TRUE when a value is NA. If you put an exclimation mark in front !is.na(data) it will tell you when teh values are not NA. 

...
For most of the training, the trainer will share their screen to walk through the website and code. It will help a lot if you have 2 monitors, so you can have the screen being shared on one monitor and your own session of RStudio open on the other.  

Four days is barely enough to scratch the surface on what you can do in R. Our goals with this training are to help you get past the initial learning curve that can be really challenging to climb on your own, and to expose you to some of the really useful things R can do for you. Hopefully this also helps build a larger community of R users in IMD who can help and share code with each other. 

<h3> Troubleshooting Iteration </h3>

Jointly, Thomas take first crack. SARAH will do breakpoints.
...
```{r Day4TroubleVerbose, echo=T, eval=F}
...
!!!!!!!!!!!!!!!!!Add breakpoints discussion here!!!!!!!!!!!!!!!!!!!!!!!!
-live demo
-use uncommented out look an do some screenshots
    -to link to an image, use ![alt-text goes here](image url goes here)

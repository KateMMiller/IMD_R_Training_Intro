...
Should you always preallocate? Probably. 
Do you really need to? Not until your code execution takes longer than you are willing to wait. 
Why not get more memory? That will appear to solve the problem. But datasets will just get bigger over time.
So I shouldn't use a for loop? No, you can when you need to, but there is an art to it. 

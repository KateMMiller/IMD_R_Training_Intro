...
I want to now set up some guidelines for initializing and using for loop output variables. This primarily refers to dataframe-like loop output variables. There are many ways to initialize this, I have done it two ways -- there are more.  
...
```
Instant dataframe and everyone is happy. Or are they? They aren't. This is called `growing` an object. Doug Burns also refers to this as the "Second Circle of R Hell" in his book *The R Inferno*. Look it up, it is great (no really, it is). To do this 1,000 times requires 0.23 seconds, 1,000,000 time took... well I quit after 13 minutes. If this were a strictly linear process it should have taken around 4 minutes to do 1,000,000 iterations - clearly it did not. 
...
```
Should you always preallocate? Yes. 
